...
\begin{thm}[de la función inversa de Balodis]
	Sea $E$ un espacio de Banach, $U \subset E$ un abierto y $f:U \to E$ con $f \in C^1$. Entonces si en $x_0 \in U$ se tiene que $Df(x_0)$ es invertible entonces $f$ es localmente invertible.
\end{thm}
